...
public class CauldronWithMilk extends LeveledCauldronBlock {

    public static final IntProperty LEVEL = Properties.LEVEL_3;

    public CauldronWithMilk(Biome.Precipitation precipitation, CauldronBehavior.CauldronBehaviorMap behaviorMap, Settings settings, Biome.Precipitation precipitation1) {
